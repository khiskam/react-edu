...
`,O=({label:e,...r})=>{const c="select_"+v.useId();return t.jsxs("div",{className:Pe,children:[t.jsx("label",{htmlFor:c,children:e}),t.jsx(Q,{...r,id:c})]})},Se=m`
  width: 100%;
  overflow: auto;
`,Ce=({...e})=>t.jsx("div",{className:Se,children:t.jsx(W,{...e})}),Le=({data:e})=>{const r=_(),c=n=>r(`${h.products}${n}`);return t.jsx(y,{children:t.jsxs(F,{gap:32,justify:"start",children:[t.jsx(d.Title,{level:2,children:"Товары"}),t.jsx(P,{gutter:[l.gap12,l.gap12],children:e.filter(n=>n.cart).map(n=>t.jsx(u,{sm:24,lg:12,children:t.jsx(G,{data:n,onClick:()=>c(n.id)})},n.id))})]})})},Oe=({data:e,addToCart:r,order:c})=>{const{productId:n}=oe(),[i,s]=v.useState(!1),a=()=>s(!1);if(!n)return null;const o=e.find(k=>k.id===+n);return o?t.jsxs(y,{children:[t.jsxs(F,{gap:32,children:[t.jsxs(P,{gutter:[l.gap12,l.gap12],children:[t.jsx(u,{span:24,children:t.jsx(d.Title,{level:2,children:o.title})}),t.jsx(u,{span:24,children:t.jsxs(j,{wrap:"wrap",children:[o.count>0?t.jsx(g,{color:"blue",children:"в наличии"}):t.jsx(g,{color:"red",children:"нет в наличии"}),o.cart?t.jsxs(g,{color:"blue",children:["в корзине: ",o.cart.count," шт."]}):null]})}),t.jsx(u,{span:24,children:t.jsx(d.Text,{children:o.descr})}),t.jsxs(u,{span:24,children:[t.jsx(d.Text,{strong:!0,children:"Цена: "}),t.jsxs(d.Text,{children:[o.price," ₽"]})]}),t.jsx(u,{span:24,children:t.jsxs(j,{gap:l.gap12,children:[o.cart?null:t.jsx(B,{type:"primary",onClick:()=>r(+n),children:"В корзину"}),o.count===0&&!o.isOrdered?t.jsx(B,{type:"primary",onClick:()=>{s(!0)},children:"Заказать"}):null]})})]}),t.jsx(T,{to:h.products,children:"← Ко всем товарам"})]}),t.jsx(J,{title:"Заказ",open:i,okText:"Заказать",onOk:()=>{c(+n),a()},onCancel:a,cancelText:"Отменить",footer:(k,{OkBtn:K,CancelBtn:D})=>t.jsxs(t.Fragment,{children:[t.jsx(K,{}),t.jsx(D,{})]}),children:t.jsx(d.Text,{children:"Вы хотите заказать?"})})]}):null},L="",f={asc:"asc",desc:"desc"},b=[{key:L,label:"Все"},{key:p.Constructor,label:"Конструктор"},{key:p.ForBoys,label:"Для мальчиков"},{key:p.ForGirls,label:"Для девочек"}],x=[{value:L,label:"Не сортировать"},{value:f.asc,label:"По возрастанию"},{value:f.desc,label:"По убыванию"}],w=[{value:L,label:"Не сортировать"},{value:f.asc,label:"По алфавиту"},{value:f.desc,label:"В обратном порядке"}],R=(e,r)=>(r[1]===L?e.delete(r[0]):e.set(r[0],r[1]),e),X={_search:{fn:(e,r)=>e.title.toLowerCase().includes(r)},_type:{fn:(e,r)=>!(r===p.Constructor&&e.category!==p.Constructor||r===p.ForBoys&&e.category!==p.ForBoys||r===p.ForGirls&&e.category!==p.ForGirls)}},N={_price:"price",_title:"title",_balance:"count"},ve=(e,r,c)=>{const{key:n,order:i}=c;let s=0;return e[n]>r[n]?s=1:e[n]<r[n]&&(s=-1),s*(i===f.asc?1:-1)},$e=e=>(r,c)=>e.reduce((n,i)=>n||ve(r,c,i),0),Te=e=>r=>e.every(c=>X[c.key].fn(r,c.query)),Fe=e=>e in X,ke=e=>e in f,Be=(e,r)=>{const c=[],n=[];e.forEach((s,a)=>{if(console.log(s,a),Fe(a))c.push({key:a,query:s});else if(a in N&&ke(s)){const o=N[a];n.push({key:o,order:s})}});let i=r;if(c.length>0){const s=Te(c);i=i.filter(s)}if(n.length>0){const s=$e(n);i=i.sort(s)}return i},Re=()=>{const[e,r]=Z(I().search),{run:c}=ie((s,a)=>{n(s,a),r(o=>R(o,[s,a]))},{wait:400}),n=(s,a)=>r(o=>R(o,[s,a]));return{setParam:n,onChange:s=>c("_search",s.target.value.toLowerCase()),searchParams:e}},Ne=e=>m`
  width: 52%;

  @media screen and (max-width: ${e.screenMD}px) {
    width: 100%;
  }
`,Me=({data:e})=>{const r=_(),c=C(),n=o=>r(`${h.products}${o}`),{onChange:i,setParam:s,searchParams:a}=Re();return t.jsx(y,{children:t.jsxs(F,{gap:32,justify:"start",children:[t.jsx(d.Title,{level:2,children:"Товары"}),t.jsx(U.Search,{placeholder:"Введите название товара",enterButton:"Искать",className:Ne(c),onChange:i,allowClear:!0}),t.jsx(Ce,{items:b,type:"card",onChange:o=>s("_type",o),defaultActiveKey:a.get("_type")??(b==null?void 0:b[0].key)}),t.jsxs(j,{wrap:"wrap",gap:l.gap12,children:[t.jsx(O,{label:"Сортировать по цене",options:x,defaultValue:a.get("_price")??(x==null?void 0:x[0].value),onChange:o=>s("_price",o)}),t.jsx(O,{label:"Сортировать по названию",options:w,defaultValue:a.get("_title")??(w==null?void 0:w[0].value),onChange:o=>s("_title",o)}),t.jsx(O,{label:"Сортировать по остатку",options:x,defaultValue:a.get("_balance")??(x==null?void 0:x[0].value),onChange:o=>s("_balance",o)})]}),t.jsx(P,{gutter:[l.gap12,l.gap12],children:Be(a,e).map(o=>t.jsx(u,{sm:24,lg:12,children:t.jsx(G,{data:o,onClick:()=>n(o.id)})},o.id))})]})})},Ie=(e,r,c)=>ee([{path:"/",element:t.jsx(ye,{}),children:[{path:h.products,element:t.jsx(Me,{data:e})},{path:`${h.products}:productId`,element:t.jsx(Oe,{data:e,addToCart:r,order:c})},{path:`${h.cart}`,element:t.jsx(Le,{data:e})}]}],{basename:"https://khiskam.github.io/react-edu"}),_e=()=>{const[e,r]=v.useState(ae),c=i=>{e.forEach((s,a)=>{if(s.id===i){r(o=>(o[a].cart={count:1},[...o]));return}})},n=i=>{e.forEach((s,a)=>{if(s.id===i){r(o=>(o[a].isOrdered=!0,[...o]));return}})};return t.jsx(Y,{theme:ne,children:t.jsx(ce,{children:t.jsx(te,{router:Ie(e,c,n)})})})};V.createRoot(document.getElementById("root")).render(t.jsx(E.StrictMode,{children:t.jsx(_e,{})}));
